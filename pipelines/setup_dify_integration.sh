...
echo "     http://sisimcp-dify-api:8002/api/detect_anomaly"
echo "     http://sisimcp-dify-api:8002/api/analyze_anomaly_reason"
echo "     http://sisimcp-dify-api:8002/api/plot_analysis"
echo ""
